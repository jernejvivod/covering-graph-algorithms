...
def greedy_logn_approx(dataset_path, visualize=False, plot_path=None):
    """Compute greedy (logn) approximation solution for the graph covering problem.
    ...
    with open(dataset_path, 'r') as f:
        ...
        # add nodes that have the maximum number of uncovered edges next to them to the covering set until all edges covered
