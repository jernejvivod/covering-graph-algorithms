...
def naive_approx(dataset_path, visualize=False, plot_path=None):
    """Compute naive approximation solution for the vertex cover problem.
    ...
    with open(dataset_path, 'r') as f:
        ...
        logger.info('Using naive approximation algorithm for the vertex cover problem for a graph specified in \'{0}\' with {1} nodes and {2} edges.'.format(dataset_path, n_nodes, n_edges))
